  ...
  return (
    <div
      style={{
        ...
        padding: '2rem',
        background:
          'linear-gradient(180deg, var(--color-bg-base) 0%, rgba(74, 222, 128, 0.05) 100%)',
      }}
    >
      <div style={{ maxWidth: '800px', width: '100%' }}>
        ...
        >
          Ground is claimed by running real loops. Defend your turf or take it from others. Every
          run has stakes.
        </p>
        ...
        >
          ...
          >
            <h3 style={{ color: '#4ade80', marginBottom: '1rem', fontSize: '1.5rem' }}>
              1. Run a Loop
            </h3>
          ...
          >
            ...
            <p style={{ color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
              If your run overlaps another player's ground, you steal it from them. Last capture
              wins.
            </p>
          </div>
        </div>
