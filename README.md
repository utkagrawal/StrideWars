...
- **Interactive Dashboard**: View your global rank, territory count, recent runs, and unread alerts on a personalized dashboard.
...
We provide a one-click bootstrap script that brings up the entire stack, runs migrations, and seeds the database with 50,000 runs to demonstrate scale.
